...
This folder defines all source code for the 'bookstore_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_bookstore_pipeline.sql" to get familiar with the syntax.
